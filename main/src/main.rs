...
use crate::collections::array2d::{Array2d, Array2dRead};
...
impl<T> AsRef<Vec<T>> for Array2d<T> {
    fn as_ref(&self) -> &Vec<T> {
        &self.data
    }
}

impl<T> AsMut<Vec<T>> for Array2d<T> {
    fn as_mut(&mut self) -> &mut Vec<T> {
        &mut self.data
    }
}

impl<T: Writable> Writable for Array2d<T> {
...
pub trait Array2dRead {
    fn read_table<T: Readable>(&mut self, d1: usize, d2: usize) -> Array2d<T>;
    fn read_int_table(&mut self, d1: usize, d2: usize) -> Array2d<i32>;
    fn read_long_table(&mut self, d1: usize, d2: usize) -> Array2d<i64>;
    fn read_size_table(&mut self, d1: usize, d2: usize) -> Array2d<usize>;
    fn read_char_table(&mut self, d1: usize, d2: usize) -> Array2d<char>;
}

impl Array2dRead for Input<'_> {
    fn read_table<T: Readable>(&mut self, d1: usize, d2: usize) -> Array2d<T> {
        Array2d::generate(d1, d2, |_, _| self.read())
    }
...
pub trait Array2dCharWrite {
    fn print_table(&mut self, table: &Array2d<char>);
}

impl Array2dCharWrite for Output {
    fn print_table(&mut self, table: &Array2d<char>) {
        let mut at = 0usize;
        for _ in 0..table.d1 {
            for _ in 0..table.d2 {
...
impl<T: Readable> Readable for Array2d<T> {
